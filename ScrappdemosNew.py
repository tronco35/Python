...
url = "https://www.seek.co.nz/power bi-jobs?salaryrange=90000-999999&salarytype=annual"# solo ofertas que sean superiores a 100 con el valor
...
if "__main__" == __name__:
        ...
        for job in results:
                try:
                    ...
                    joblink = "https://www.seek.co.nz" + titleElement['href']# retorna el lnk de la oferta laboral
